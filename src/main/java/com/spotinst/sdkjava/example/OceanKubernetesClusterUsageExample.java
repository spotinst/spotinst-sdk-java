...
public class OceanKubernetesClusterUsageExample {
    ...
    private static String createCluster(SpotOceanClusterClient client) {
        ...
        //todo lihi - Done -  extract all mandatory filed to be members of the class, that should be filled by whoever runs the example.
        ...
        ClusterIamInstanceProfileSpec iamInstanceProfileSpec =
                iamInstanceProfileBuilder.setArn(arnRole).build();
        ...
        ClusterLaunchSpecification launchSpecification =
                launchSpecificatioBuilder.setSecurityGroupIds(securityGroups).setAssociatePublicIpAddress(true)
                                         ...
                                         .setImageId(launchSpecificationImageId).setTags(tagsList)
                                         .setKeyPair(keyPair).build();
    ...
    private static void updateCluster(SpotOceanClusterClient client, String clusterId) {
        ...
        ClusterStrategyConfiguration updateStrategy =
                updateStrategyBuilder.setGracePeriod(null).build();
