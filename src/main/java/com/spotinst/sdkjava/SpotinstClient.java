...
public class SpotinstClient {
    ...
    public static SpotinstAdminAccountClient getAdminAccountClient(String authToken) {
        SpotinstAdminAccountClient spotAdminAccountClient = new SpotinstAdminAccountClient(authToken);
