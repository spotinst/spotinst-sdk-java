...
public class MrScalerAwsConverter {
    ...
    public static BlMrScalerAwsComputeConfiguration computeApiToBl(ApiMrScalerAwsComputeConfiguration apiCompute){
        ...
        if(apiCompute != null){
            ...
            if(apiCompute.isApplicationsSet()){
                List<BlMrScalerAwsApplication> blApplications = convertApplicationApitToBl(apiCompute.getApplications());
                blCompute.setApplications(blApplications);
            }
            if(apiCompute.isInstanceGroupsSet()){
                BlMrScalerAwsInstancegroups blInstanceGroups = convertInstanceGroupsApiToBl(apiCompute.getInstanceGroups());
    ...
    public static List<BlMrScalerAwsApplication> convertApplicationApitToBl(List<ApiMrScalerAwsApplication> apiApplications){
    ...
    public static BlMrScalerAwsInstancegroups convertInstanceGroupsApiToBl(ApiMrScalerAwsInstancegroups apiInstancegroups){
    ...
    public static BlMrScalerAwsCoreGroup convertCoreGroupApiToBl(ApiMrScalerAwsCoreGroup apiCoreGroup){
        ...
        if(apiCoreGroup != null){
            ...
            if(apiCoreGroup.isEbsConfigurationSet()){
                BlMrScalerAwsEbsConfiguration blEbsConfiguration = convertEbsConfigApiToBl(apiCoreGroup.getEbsConfiguration());
    ...
    public static BlMrScalerAwsMasterGroup convertMasterGroupApiToBl(ApiMrScalerAwsMasterGroup apiMasterGroup){
        ...
        if(apiMasterGroup != null){
            ...
            if(apiMasterGroup.isEbsConfigurationSet()){
                BlMrScalerAwsEbsConfiguration blEbsConfig = convertEbsConfigApiToBl(apiMasterGroup.getEbsConfiguration());
    ...
    public static List<BlMrScalerAwsScalingPolicy> convertScalingPolicyApiToBl(List<ApiMrScalerAwsScalingPolicy> apiScalingPolicies){
    ...
    // region Scheduling
    public static BlMrScalerAwsSchedulingConfiguration schedulingApiToBl(ApiMrScalerAwsSchedulingConfiguration apiScheduling){
    ...
    public static ApiMrScalerAwsComputeConfiguration computeBlToApi(BlMrScalerAwsComputeConfiguration blCompute){
        ...
        if(blCompute != null){
            ...
            if(blCompute.getApplications()!=null){
                List<ApiMrScalerAwsApplication> apiApplications = convertApplicationBlToApi(blCompute.getApplications());
                apiCompute.setApplications(apiApplications);
            }
            if(blCompute.getInstanceGroups()!=null){
                ApiMrScalerAwsInstancegroups apiInstanceGroups = convertInstanceGroupsBlToApi(blCompute.getInstanceGroups());
    ...
    public static List<ApiMrScalerAwsApplication> convertApplicationBlToApi(List<BlMrScalerAwsApplication> blApplications){
    ...
    public static ApiMrScalerAwsInstancegroups convertInstanceGroupsBlToApi(BlMrScalerAwsInstancegroups blInstanceGroups){
    ...
    public static ApiMrScalerAwsCoreGroup convertCoreGroupBlToApi(BlMrScalerAwsCoreGroup blCoreGroup){
        ...
        if(blCoreGroup != null){
            ...
            if(blCoreGroup.getEbsConfiguration()!=null){
                ApiMrScalerAwsEbsConfiguration apiEbsConfiguration = convertEbsConfigBlToApi(blCoreGroup.getEbsConfiguration());
    ...
    public static ApiMrScalerAwsMasterGroup convertMasterGroupBlToApi(BlMrScalerAwsMasterGroup blMasterGroup){
        ...
        if(blMasterGroup != null){
            ...
            if(blMasterGroup.getEbsConfiguration()!=null){
                ApiMrScalerAwsEbsConfiguration apiEbsConfig = convertEbsConfigBlToApi(blMasterGroup.getEbsConfiguration());
    ...
    public static ApiMrScalerAwsTaskGroup convertTaskGroupBlToApi(BlMrScalerAwsTaskGroup blTaskGroup){
        ...
        if(blTaskGroup != null){
            ...
            if(blTaskGroup.getEbsConfiguration()!=null){
                ApiMrScalerAwsEbsConfiguration apiEbsConfig = convertEbsConfigBlToApi(blTaskGroup.getEbsConfiguration());
    ...
    public static List<ApiMrScalerAwsScalingPolicy> convertScalingPolicyBlToApi(List<BlMrScalerAwsScalingPolicy> blScalingPolicies){
    ...
    // region Scheduling
    public static ApiMrScalerAwsSchedulingConfiguration schedulingBlToApi(BlMrScalerAwsSchedulingConfiguration blScheduling){
