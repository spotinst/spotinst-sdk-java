...
public class ApiElastigroupEcsInitiateRollResponseOldInstances implements IPartialUpdateEntity {
    @JsonIgnore
    ...
    public ApiElastigroupEcsInitiateRollResponseOldInstances() {
        isSet = new HashSet<>();
    }
