...
public class PlacementAzure {
    ...
    //region Constructors
    private PlacementAzure() {
        isSet = new HashSet<>();
    }

    public PlacementAzure(String azName, List<String> subnetIds) {
        this.setAzName(azName);
        this.setSubnetIds(subnetIds);
    }

    public PlacementAzure(String azName, String subnetId) {
        this.setAzName(azName);
        this.setSubnetIds(Arrays.asList(subnetId));
    }

    public PlacementAzure(PlacementAzure src) {
        if (src != null) {
    ...
    public boolean equals(Object o) {
        ...
        PlacementAzure that = (PlacementAzure) o;
    ...
    public static class Builder {
        private PlacementAzure placement;

        private Builder() {
            this.placement = new PlacementAzure();
        }
