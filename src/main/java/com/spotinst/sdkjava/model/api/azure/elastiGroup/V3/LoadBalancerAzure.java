...
import com.spotinst.sdkjava.enums.LbTypeEnumAzure;
...
public class LoadBalancerAzure {
    ...
    public LbTypeEnumAzure getType() {
        return type;
    }

    public void setType(LbTypeEnumAzure type) {
        isSet.add("type");
        this.type = type;
    }
    //endregion
    ...
    public static class Builder {
        ...
        public LoadBalancerAzure.Builder setType(final LbTypeEnumAzure type) {
