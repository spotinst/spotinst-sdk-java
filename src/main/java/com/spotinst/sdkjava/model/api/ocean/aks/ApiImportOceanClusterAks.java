...
public class ApiImportOceanClusterAks implements IPartialUpdateEntity {
    ...
    public ApiImportOceanClusterAks() {
        isSet = new HashSet<>();
    }
    ...
    public ApiImportOceanClusterAks setIsSet(Set<String> isSet) {
        this.isSet = isSet;
        return this;
    }
