...
import com.spotinst.sdkjava.model.IpAddress;
...
public class NetworkInterfaceAzure {
    ...
    private List<IpAddressAzure> privateIpAddresses;
    ...
    public List<IpAddressAzure> getPrivateIpAddresses() {
        return privateIpAddresses;
    }

    public void setPrivateIpAddresses(List<IpAddressAzure> privateIpAddresses) {
    ...
    public boolean equals(Object o) {
        ...
        NetworkInterfaceAzure that = (NetworkInterfaceAzure) o;
    ...
    public static class Builder {
        ...
        public Builder setPrivateIpAddresses(final List<IpAddressAzure> ipAddresses) {
