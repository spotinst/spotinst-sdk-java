 ...
 */
public class ElastigroupEbsVolumePoolAzure {
    @JsonIgnore
    ...
    private ElastigroupEbsVolumePoolAzure() {
        isSet = new HashSet<>();
    }
    //endregion
    ...
    public static class Builder {
        private ElastigroupEbsVolumePoolAzure ebsVolumePool;

        private Builder() {
            this.ebsVolumePool = new ElastigroupEbsVolumePoolAzure();
        }
        ...
        public ElastigroupEbsVolumePoolAzure build() {
            // TODO : Validations
