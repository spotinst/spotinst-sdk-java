...
public class ElastigroupHeadroomSpecificationAzure {
    //region Members
    @JsonIgnore
    ...
    private ElastigroupHeadroomSpecificationAzure() {
        isSet = new HashSet<>();
    }
    //endregion
    ...
    public static class Builder {
        ...
        private Builder() {
            this.headroom = new ElastigroupHeadroomSpecificationAzure();
        }
        ...
        public ElastigroupHeadroomSpecificationAzure build() {
            return headroom;
        }
    }
    //endregion
