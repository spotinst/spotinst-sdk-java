...
public class ApiClusterAutoScalerConfiguration implements IPartialUpdateEntity {
    ...
    private ApiLaunchSpecHeadRoomsSpecification     headroom;
    ...
    public ApiLaunchSpecHeadRoomsSpecification getHeadroom() {
        return headroom;
    }

    public void setHeadroom(ApiLaunchSpecHeadRoomsSpecification headroom) {
        isSet.add("headroom");
