...
public class ApiGetEcsClusterNodesResponse implements IPartialUpdateEntity {
    ...
    public static class Builder {
        private ApiGetEcsClusterNodesResponse clusterNodes;

        private Builder() {
            this.clusterNodes = new ApiGetEcsClusterNodesResponse();
        }
        ...
        public Builder setWorkloadRequestedMilliCpu(final Integer workloadRequestedCpuUnit) {
        ...
        public ApiGetEcsClusterNodesResponse build() {
            // Validations
            return clusterNodes;
        }
    }
