...
public interface ISpotOceanK8sClusterRepo extends IRepository<OceanK8sCluster, Void, String>{
    ...
    RepoGenericResponse<OceanK8sCluster> importASGToOceanCluster(ImportAsgToClusterInstanceTypes importRequest, String autoScalingGroupName, String region, String authToken, String account);
