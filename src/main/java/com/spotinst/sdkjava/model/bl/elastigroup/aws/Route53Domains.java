...
public class Route53Domains {
    ...
    public static class Builder {
        private Route53Domains route53Domains;

        private Builder() {
            this.route53Domains = new Route53Domains();
        }
        ...
        public Builder setHostedZoneId(final String hostedZoneId) {
            route53Domains.setHostedZoneId(hostedZoneId);
            return this;
        }

        public Builder setRecordSets(final List<RecordSets> recordSets) {
            route53Domains.setRecordSets(recordSets);
            return this;
        }

        public Builder  setRecordSetType(final Route53RecordSetType recordSetType) {
            route53Domains.setRecordSetType(recordSetType);
            return this;
        }

        public Builder setSpotinstAccountId(final String spotinstAccountId) {
            route53Domains.setSpotinstAccountId(spotinstAccountId);
            return this;
        }

        public Route53Domains build() {
