...
public class ElastigroupScalingVms {
    ...
    public static class Builder {
        private ElastigroupScalingVms vmsAzure;

        private Builder() {
            this.vmsAzure = new ElastigroupScalingVms();
        }
        ...
        public ElastigroupScalingVms build() {
            return vmsAzure;
        }
    }
