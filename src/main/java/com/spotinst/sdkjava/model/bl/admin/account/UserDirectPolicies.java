...
public class UserDirectPolicies {
    @JsonIgnore
    private Set<String>  isSet;
    private String       policyId;
    private List<String> accountIds;

    public UserDirectPolicies() {
        isSet = new HashSet<>();
    }
    ...
    public static class Builder {
        private UserDirectPolicies policy;

        private Builder() {
            this.policy = new UserDirectPolicies();
        }
        ...
        public UserDirectPolicies build() {
            return policy;
        }
    }
