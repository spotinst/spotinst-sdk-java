...
public class EcsInitiateRollResponseOldInstances {
    @JsonIgnore
    private Set<String>                     isSet;
    private String                     instanceId;
    private String                         status;

    private EcsInitiateRollResponseOldInstances() {
        isSet = new HashSet<>();
    }
    ...
    public static class Builder {
        private EcsInitiateRollResponseOldInstances initiateRollOldInstances;

        private Builder() {
            this.initiateRollOldInstances = new EcsInitiateRollResponseOldInstances();
        }
        ...
        public EcsInitiateRollResponseOldInstances build() {
