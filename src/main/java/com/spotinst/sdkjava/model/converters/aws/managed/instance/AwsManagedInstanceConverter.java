package com.spotinst.sdkjava.model.converters.aws.managed.instance;

import com.spotinst.sdkjava.enums.SchedulingTaskTypeEnum;
import com.spotinst.sdkjava.model.RecurrenceFrequencyEnum;
import com.spotinst.sdkjava.model.api.aws.managed.instance.*;
...
public class AwsManagedInstanceConverter {
    ...
    private static ApiAmiBackup toDal(AmiBackup amiBackup) {
