...
public class OceanGkeConverter {
    ...
    public static ApiLaunchSpecSpecification toDal(LaunchSpecSpecification src) {
        ...
        if (src != null) {
            ...
            if (src.isIpForwardingSet()) {
                apiLaunchSpec.setIpForwarding(src.getIpForwarding());
            }
            if (src.isMinCpuPlatformSet()) {
                apiLaunchSpec.setMinCpuPlatform(src.getMinCpuPlatform());
            }
            if (src.isTagsSet()) {
                apiLaunchSpec.setTags(src.getTags());
            }
        }
