package com.spotinst.sdkjava.model.responses;
...
public class ElastigroupApiDeploymentDetailsResponseAzure extends BaseServiceItemsResponse<ApiGroupDeploymentDetailsAzure> {
