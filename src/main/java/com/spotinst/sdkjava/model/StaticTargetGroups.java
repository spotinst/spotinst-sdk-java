 ...
 */
public class StaticTargetGroups {
    ...
    public static class Builder {
        private StaticTargetGroups defaultStaticTargetGroups;

        private Builder() {
            this.defaultStaticTargetGroups = new StaticTargetGroups();
        }
        ...
        public StaticTargetGroups build() {
